...
## Current Status
Feature 04 complete — Arabic-first localization foundation is in place. The app runs in Arabic by default, RTL layout is enabled, and all student browse screens (Academic Years, Subjects, Courses) use translation keys instead of hardcoded English text.

## Next Up
Feature 05 — Build Shared Design Foundations
...
### Not Started
- 05 — Build Shared Design Foundations
- 06 — Create Mock Data Layer
- 07 — Build Student Home Screen
- 08 — Build Subject/Course Browsing Screens
- 09 — Build Course Detail and Lessons Screens
- 10 — Build Teacher Home Screen
- 11 — Build Teacher Course Management UI
- 12 — Build Profile and Payment Info Screens
- 13 — Connect Navigation Flows
- 14 — Polish UI and Empty/Error States
- 15 — Prepare First APK Build
- 16 — Backend Phase (deferred for now per mock-data-first plan)
